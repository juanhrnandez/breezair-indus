...
import { PHONE_DISPLAY, EMAIL_SALES } from '@/lib/site';
  ...
  async function submit(e) {
    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          // La API espera el contrato en inglés; enviar 'nombre'/'empresa'
          // devolvía 400 y el lead se perdía en silencio.
          name: form.nombre,
          email: form.email,
          phone: form.telefono,
          company: form.empresa,
          sector: form.industria,
          inquiryType: form.tipoConsulta,
          projectSize: form.area,
          message: form.mensaje,
          formName: 'contact_form_premium'
        })
      });
